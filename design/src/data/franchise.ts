...
export const franchiseSteps: FranchiseStep[] = [
{
  ...
  description: 'Complete the online qualification funnel so we understand your capital tier, preferred territory and timeline.',
  duration: '5 minutes'
},
{
  number: 2,
  title: 'Discovery Call',
  description: 'Initial review of financial capability, operational goals and target territories across Singapore.',
  duration: 'Week 1'
},
{
  number: 3,
  title: 'Location Evaluation',
  description: 'Site selection, foot traffic data analysis and technical feasibility studies for power and water supply.',
  duration: 'Weeks 2–5'
},
{
  number: 4,
...
},
{
  ...
  description: 'Interior renovation to brand guidelines, equipment integration (washers, dryers, vending) and network configuration.',
  duration: 'Weeks 7–12'
},
{
  number: 6,
