        ...
        <div className="grid gap-12 lg:grid-cols-[1.2fr_2fr]">
          <div>
            <div className="flex items-center gap-3">
              <img src={LOGO_URL} alt="" className="h-14 w-14 rounded-full bg-white object-contain" />
            ...
            <p className="mt-5 max-w-sm text-sm leading-relaxed">
              Singapore's 24/7 smart laundromat and premium vending network — the modern household partner for busy
              homes and hands-off investors.
            </p>
