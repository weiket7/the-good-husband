import { SmartphoneNfcIcon, RadioTowerIcon, PackageCheckIcon, SparklesIcon, ShieldCheckIcon } from 'lucide-react';
          ...
          <div>
            ...
            <div className="mt-9 rounded-3xl border border-white/10 bg-white/5 p-6">
              ...
              <p className="mt-4 text-sm leading-relaxed text-white/70">
                No coins, no hassle. Every machine in our network is outfitted with state-of-the-art cashless
                terminals for instantaneous, secure transactions.
              </p>
