...
export function FranchiseForm() {
    ...
    return (
      <div className="rounded-3xl border border-brand-200 bg-brand-50 p-8 text-center">
        ...
        <p className="mx-auto mt-3 max-w-md text-sm leading-relaxed text-ink-soft">
          Thanks {form.name.split(' ')[0] || 'there'} — our franchise team will reach out within two working days
          with the capital tier guidelines and next steps for a discovery call.
        </p>
        <button
          type="button"
          onClick={() => {
  ...
  return (
    <form onSubmit={submit} className="rounded-3xl border border-slate-200 bg-white p-6 sm:p-8" noValidate>
      ...
      <p className="mt-4 text-xs leading-relaxed text-ink-muted">
        By submitting, you agree to be contacted about franchise opportunities. We never share your details with
        third parties.
      </p>
    </form>
  );
